...
# ScholarRAG — 3-Tier Application Deployment Portfolio
...
# Overall Learning & Technical Growth

During the **SkillNebula Cloud & DevOps Batch 2.0**, under the guidance of **Ujjwal Pratap Singh** sir, I improved my skills from a beginner to a confident Backend & DevOps learner through hands-on projects and practical training.

This journey helped me understand how modern applications are built, deployed, and managed in real-world environments.
...
**Scholar RAG** is a scalable, 3-tier production application featuring a decoupled frontend, backend, and database architecture designed to ingest, process, and query research documents efficiently using Retrieval-Augmented Generation (RAG) principles.
...
<img width="2000" height="1414" alt="Anurag Kashyap jpg" src="https://github.com/user-attachments/assets/b47f7de4-48e9-411f-8df3-61e5f01cecfd" />
...
I would like to express my sincere gratitude to my mentor, **[Ujjwal Pratap Singh](https://www.linkedin.com/in/ujjwal-pratap-singh/?skipRedirect=true)**, and the entire team at **[Skill Nebula Private Limited](https://www.linkedin.com/company/skillnebula/posts/?feedView=all)** for their continuous guidance, patience, and support throughout this cloud & DevOps training program. 

This opportunity has been instrumental in bridging the gap between academic concepts and real-world systems engineering. The hands-on exposure to scalable multi-tier architectures, container orchestration, and cloud deployments has significantly elevated both my technical capabilities and my collaborative mindset as an aspiring engineer.
